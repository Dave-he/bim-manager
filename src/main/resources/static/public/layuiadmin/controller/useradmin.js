...
layui.define(['table', 'form'], function(exports){
  ...
  table.render({
    ...
    ,url: '/public/layuiadmin/json/useradmin/webuser.js' //模拟接口
    ,cols: [[
  ...
  table.render({
    ...
    ,url: '/public/layuiadmin/json/useradmin/mangadmin.js' //模拟接口
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
  ...
  table.render({
    ...
    ,url: '/public/layuiadmin/json/useradmin/role.js' //模拟接口
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'id', width: 80, title: 'ID', sort: true}
