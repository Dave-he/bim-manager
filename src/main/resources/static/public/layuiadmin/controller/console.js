  ...
  */
  ...
  layui.use('table', function(){
    ...
    table.render({
      ...
      ,url: '/public/layuiadmin/json/console/top-search.js' //模拟接口
      ,page: true
      ,cols: [[
    ...
    table.render({
      ...
      ,url: '/public/layuiadmin/json/console/top-card.js' //模拟接口
      ,page: true
      ,cellMinWidth: 120
      ,cols: [[
        {type: 'numbers', fixed: 'left'}
